...
SELECT cva.location, cva.date_converted, cde.population, CAST(people_vaccinated as bigint) as total_people_vaccinated, 
	CAST(people_fully_vaccinated as bigint) as people_fully_vaccinated, 
	((CAST(people_vaccinated as bigint))-(CAST(people_fully_vaccinated as bigint))) as people_partially_vaccinated , 
	(cde.population-(CAST(people_vaccinated as bigint))) as people_not_vaccinated
